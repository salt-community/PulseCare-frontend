...
export const PreviousAppointments = ({ appointments }: AppointmentProps) => {
	...
	return (
		<Card className="shadow-sm rounded-xl flex-1 flex flex-col justify-center">
			<CardHeader className="p-4 pb-0">Previous Appointments</CardHeader>

			<CardContent className="overflow-scroll">
				{appointments.length === 0 ? (
					<p className="text-center text-muted-foreground">No previous appointments</p>
				) : (
