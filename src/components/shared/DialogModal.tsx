	...
	return (
		<Dialog.Root open={open} onOpenChange={onOpenChange}>
			...
			<Dialog.Portal>
				...
				<Dialog.Content className="fixed left-1/2 top-[calc(19.25*0.25rem+50%)] -translate-x-1/2 -translate-y-1/2 w-[min(95%,32rem)] max-h-[calc(100vh-19.25*0.25rem-1rem)] overflow-auto bg-background-secondary rounded-2xl p-4 z-50">
